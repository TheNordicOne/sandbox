...
export class ReusableFormPartWithLoadingStateComponent
  implements OnInit, OnDestroy
{
    ...
    loader: ({ request }) =>
      this.httpClient
        .get<UserSearchResponse>(
          `${this.userEndpoint}/search?q=${request.q}&delay=${request.delay}`,
        )
  ...
  ngOnInit(): void {
    this.parentFormGroup.addControl('user', new FormControl(''))
  }
